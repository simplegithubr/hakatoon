...
export default function LatestBlog() {
  return (
    <div className='md:w-[1200px] w-full h-full md:h-[500px] mx-auto text-center'>
        <div className='max-w-[400px] w-full mx-auto'>
        <h1 className='text-3xl font-bold  mb-8 text-[#1A0B5B] '>Leatest Blog</h1>
        </div>
        <div className='flex flex-col md:flex-row'>
          <div className='max-w-[400px] w-full md:h-[430px] h-full'>
            <div className=' ml-9'>
        <Image src="/blogimg (1).png" alt='' width={300} height={250}></Image>
              ...
              <div className='md:w-[400px] w-full mt-2'>
               ...
               <div className='max-w-[400px] w-full h-full  md:h-[430px]'>
            <div className=' ml-9'>
        <Image src="/blogimg (1).png" alt='' width={300} height={250}></Image>
        </div>
              <div className='md;w-[400px] w-full mt-2'>
                ...
                over tightly circa   horse taped mightly</p>
                 ...
                 <div className='max-w-[400px] h-full md:h-[430px]'>
            <div className=' ml-9'>
        <Image src="/blogimg (1).png" alt='' width={300} height={250}></Image>
        </div>
              <div className='md:w-[400px] w-full mt-2'>
